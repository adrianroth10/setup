...
pip3 install --user opencv-contrib-python  # this works sufficiently for ubuntu 20
...
# 	#prerequisites
# 	$PACKAGE_INSTALL build-essential cmake git libgtk2.0-dev pkg-config libavcodec-dev libavformat-dev libswscale-dev python-dev python-numpy libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libdc1394-22-dev libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libxvidcore-dev libx264-dev libgtk-3-dev libatlas-base-dev gfortran pylint python2.7-dev python3.8-dev
# 
